...
public class PHHomeActivity extends Activity implements OnItemClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    hueManager.setAppName("HuePhotoLamp");

    // Register the PHSDKListener to receive callbacks from the bridge.
    hueManager.getPhHueSDK().getNotificationManager().registerSDKListener(listener);
   ...
   //lastIpAddress = "10.0.2.2:8000";
   //lastUsername= "newdeveloper";

    dialog = new Dialog(this);
    dialog.setContentView(R.layout.startsettingpage);
    ...
    ((EditText) dialog.findViewById(R.id.user_name_editText)).setText(lastUsername);
    ((EditText) dialog.findViewById(R.id.ip_editText)).setText(lastIpAddress);
